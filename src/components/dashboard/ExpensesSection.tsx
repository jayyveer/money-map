...
export function ExpensesSection() {
  ...
  const getCategoryColor = (category: string) => {
    return CATEGORY_COLORS[category as keyof typeof CATEGORY_COLORS] || '#AAAAAA'
  }
                    ...
                    <CardContent className="p-4">
                      <div className="flex justify-between items-start">
                        ...
                        <div 
                          ...
                          style={{ backgroundColor: getCategoryColor(category.category) + '33' }}
                        >
                          <span 
              ...
              {isLoading ? (
                ...
                <div className="space-y-4 max-h-96 overflow-auto pr-2">
                  {expenses.slice(0, 10).map((expense) => {
                    const isExpense = expense.dr_cr === 'DR' || !expense.income;
                    return (
                      <div key={expense.id} className="flex items-start gap-4 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                        <div 
